  ...
  <div class="uk-container">
    ...
    <div class="uk-card uk-card-default uk-card-body">
      ...
      <div class="uk-card-body">
        ...
        <form method="POST" action="{{ route('product-update',['id'=>$id]) }}" class="uk-form-horizontal uk-margin-large"  enctype="multipart/form-data">
          @csrf
          ...
          <div class="uk-margin">
            ...
            <div class="uk-form-controls">
              ...
              @endif
              <div class="uk-margin">
                <img id="output_image" src="/image/product/{{$product->product_image}}" alt="">
              </div>
            </div>
          </div>
